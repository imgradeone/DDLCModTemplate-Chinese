...
### 阿里巴巴 / 阿里巴巴普惠体
单独下载：https://ics.alibaba.com/project/Hn8mXx 或者 https://alibabafont.taobao.com/ （均需要淘宝帐号）
...
1. 将模板文件解压到刚刚你解压 Ren'Py SDK 的文件夹里。（例如，`renpy-6.99.12.4-sdk`）
...
1. 现在，打开 Ren'Py SDK，启动工程。正常情况下，工程将会完美启动。
1. 接下来，开始你的写 Mod 之旅吧！
