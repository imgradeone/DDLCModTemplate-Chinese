...
label credits_example:
    ...
    pause 0.5
    $ consolehistory = []
    call updateconsole("renpy.jump(\"credits_example\")", "Loading label \"credits_example\"...")
    pause 1.0
    call hideconsole
...
label credits_part2:
    ...
    $ lockedtext = "_clearall"
    $ imagenum += 1
    show image ("credits_cg1" + lockedtext) at credits_scroll_right as credits_image_1

    #Actual names for the credits
    show credits_header "DDLC 中文 Mod 模板制作者" at credits_text_scroll_left as credits_header_1
    show credits_text "imgradeone\n（a.k.a 一年级么么哒 / InsanerYuri）" at credits_text_scroll_left as credits_text_1
    ...
    show credits_header "DDLC 原作" at credits_text_scroll_right as credits_header_2
    show credits_text "Dan Salvato / 剧本、代码、音乐\nSatchely / 角色画师\nVelinquent / 背景画师\nJillian Ashcraft / Monika 配音" at credits_text_scroll_right as credits_text_2
    ...
    show credits_header "英文 Mod 模板原作" at credits_text_scroll_left as credits_header_1
    show credits_text "Monika After Story 团队\n（本模板基于该团队的模板进行优化）" at credits_text_scroll_left as credits_text_1
    ...
    show credits_header "中文 Mod 模板开发参与者" at credits_text_scroll_right as credits_header_2
    show credits_text "Liu Wenyuan\n（@Dobby233Liu）" at credits_text_scroll_right as credits_text_2
    ...
    show credits_header "模板特殊功能设计" at credits_text_scroll_left as credits_header_1
    show credits_text "imgradeone 以及各位大佬" at credits_text_scroll_left as credits_text_1
    ...
    show credits_header "中文字体作者" at credits_text_scroll_right as credits_header_2
    show credits_text "阿里巴巴\n站酷字体\n杨任东字体\n思源宋体作者\n萧熠Siue\n8:51:22 pm\n新叶传媒\nlxfly2000" at credits_text_scroll_right as credits_text_2
    ...
    show credits_text "MTR / 对本模板的支持\n所有代码贡献者\n所有中文字体作者" at credits_text_scroll_left as credits_text_1
    ...
    show credits_text "所有 DDLC 粉丝对原作的支持" at credits_text_scroll_right as credits_text_2
    ...
    show credits_header "特别感谢" at credits_text_scroll_left as credits_header_1
    show credits_text "Team Salvato 对粉丝同人创作的支持" at credits_text_scroll_left as credits_text_1
    ...
    show credits_header "特别感谢" at credits_text_scroll_right as credits_header_2
    show credits_text "所有 Mod 开发者\n还有正在游玩 Mod 的 [player]" at credits_text_scroll_right as credits_text_2
